 ...
 */
object Client {
    var restaurantMap: MutableMap<String, Restaurant> = mutableMapOf()
    var resList1: MutableList<Restaurant> = mutableListOf()
    var prefList1: MutableList<Preference> = mutableListOf()
    lateinit var rel: RelatedRestaurants
